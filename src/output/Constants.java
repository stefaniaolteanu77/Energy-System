...
public final class Constants {
  ...
  public static final String INITIAL_INF_COST = "initialInfrastructureCost";
  public static final String MONTHLY_UPDATES = "monthlyUpdates";
  public static final String NEW_CONSUMERS = "newConsumers";
  public static final String DIST_CHANGES = "distributorChanges";
  public static final String PROD_CHANGES = "producerChanges";
  ...
  public static final String ENERGY_PER_DIST = "energyPerDistributor";
  public static final double PROFIT_CONSTANT = 0.2;
  public static final double OWED_VALUE_CONSTANT = 1.2;
}
